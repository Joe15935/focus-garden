...
Verified 2026-09-21 with Agent Reach's Exa search and GitHub CLI. Source-only audit, not an installed-app PASS. Independent temporary checkouts were used for inspection. No audited app was installed. All decisions preserve UNKNOWN where runtime compatibility was not exercised.
