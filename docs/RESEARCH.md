...
以 c49a980f4b2b9c09c4520001a0cdc4f11466feff 为固定底座（v0.7.3）。保留上游 Git 历史及 upstream remote；本次不创建远端fork、不发布。MIT允许修改与自行编译。复用匹配模型、SQLite、计划、额度、编辑器和中文资源。核心165项单元测试及1项文档测试在本机命令行SDK下通过。
